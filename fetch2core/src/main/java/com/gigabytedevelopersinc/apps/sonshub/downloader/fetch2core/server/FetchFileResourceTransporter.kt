...
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2core.server.FileResponse.CREATOR.FIELD_CONNECTION
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2core.server.FileResponse.CREATOR.FIELD_CONTENT_LENGTH
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2core.server.FileResponse.CREATOR.FIELD_DATE
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2core.server.FileResponse.CREATOR.FIELD_MD5
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2core.server.FileResponse.CREATOR.FIELD_SESSION_ID
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2core.server.FileResponse.CREATOR.FIELD_STATUS
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2core.server.FileResponse.CREATOR.FIELD_TYPE

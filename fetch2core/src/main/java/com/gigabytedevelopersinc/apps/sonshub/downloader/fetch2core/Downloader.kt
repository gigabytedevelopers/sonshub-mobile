 ...
 * For an example see
 * @see com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.HttpUrlConnectionDownloader
 * */
interface Downloader<T, R> : Closeable {
     ...
     * For an example:
     * @see com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.HttpUrlConnectionDownloader.execute
     * */
     ...
     * and input stream if a connection was successful.
     * @see com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.HttpUrlConnectionDownloader.disconnect
     * */

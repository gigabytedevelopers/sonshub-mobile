...
public class Fiction extends Fragment {
    ...
    private void getAfricanList() {
        String AFRICAN_URL = "https://sonshub.co/wp-json/wp/v2/posts?categories=11&per_page=10&page=1";
    ...
    private void updateAfricanList(String imageUrl, String title, String link,String description, String time,String content) {
        ...
        adapter.setOnBottomReachedListener(position -> {
            String AFRICAN_URL = "https://sonshub.co/wp-json/wp/v2/posts?categories=11&per_page=10&page=" + pageNum;
            pageNum = pageNum + 1;

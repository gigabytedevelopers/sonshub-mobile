...
public class WesternFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWaveSwipeRefreshLayout.setOnRefreshListener(this::getAlbumList);
    ...
    private void getAlbumList(){
        String AFRICAN_URL = "https://sonshub.com/wp-json/wp/v2/posts?categories=3&per_page=10&page=1";
    ...
    private void updateAlbumList(String imageUrl, String title, String link,String description, String time,String content){
        ...
        adapter.setOnBottomReachedListener(position -> {
            String AFRICAN_URL = "https://sonshub.com/wp-json/wp/v2/posts?categories=3&per_page=10&page=" + pageNum;
            pageNum = pageNum + 1;
            ...
            JsonArrayRequest africanRequest = new JsonArrayRequest(AFRICAN_URL, response -> {
                ...
                try {
                    for (int i = 0; i < response.length(); i++){
                        ...
                        String link = obj.getString("link");
                        String movieImage = obj.getString("jetpack_featured_media_url");
                        updateloadMoreAlbumList(movieImage,mainTitle,link,newDescription,time,content);
                    }

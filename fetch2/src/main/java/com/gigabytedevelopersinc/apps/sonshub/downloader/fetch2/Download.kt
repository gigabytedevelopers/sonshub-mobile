...
interface Download : Parcelable, Serializable {
     ...
     * @see com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.Priority
     * */
     ...
     *  @see com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.Status
     *  */
    val status: Status
     ...
     *  @see com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.Error
     *  */
    val error: Error

    /** The network type this download is allowed to download on.
     * @see com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.NetworkType
     * */

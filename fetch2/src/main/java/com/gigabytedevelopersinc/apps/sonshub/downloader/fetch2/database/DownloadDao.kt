package com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database

import androidx.room.*
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.Status
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_CREATED
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_FILE
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_GROUP
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_ID
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_IDENTIFIER
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_PRIORITY
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_STATUS
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.COLUMN_TAG
import com.gigabytedevelopersinc.apps.sonshub.downloader.fetch2.database.DownloadDatabase.Companion.TABLE_NAME
